//
//  Business_Group_DirectoruyListViewController.m
//  MobileAssistant
//
...
#import "Business_Group_DirectoruyListViewController.h"
...
#import "Business_Group_DirectoruyDetailViewController.h"

@interface Business_Group_DirectoruyListViewController ()<MBProgressHUDDelegate>{
...
@implementation Business_Group_DirectoruyListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Business_Group_DirectoruyDetailViewController *vc = [[Business_Group_DirectoruyDetailViewController alloc]init];
        ...
        if (state == 1) {
            ...
            if ([array count] > 0) {
                ...
                if (BillId.length > 0) {
                    ...
                    [HUD hide:YES];
                    UIAlertView* alert=[[UIAlertView alloc] initWithTitle:@"提示" message:@"该集团尚未办理集团号簿业务" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
...
- (IBAction)doAdd_D_Contact:(UIButton *)sender {

    Business_Add_Group_DirectoruyViewController *vc = [[Business_Add_Group_DirectoruyViewController alloc]init];
