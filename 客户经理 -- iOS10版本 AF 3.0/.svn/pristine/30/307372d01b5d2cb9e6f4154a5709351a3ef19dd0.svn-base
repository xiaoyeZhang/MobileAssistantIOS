//
//  Business_Group_DirectoruyViewController.h
//  MobileAssistant
//
...
@interface Business_Group_DirectoruyViewController : XYBaseViewController<UITableViewDelegate,UITableViewDataSource>
{
