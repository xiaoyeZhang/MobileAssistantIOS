//
//  Business_Group_V_NetViewController.m
//  MobileAssistant
//
...
@interface Business_Group_V_NetViewController ()<MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
...
@implementation Business_Group_V_NetViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Business_Group_V_Net_ContactViewController *vc = [[Business_Group_V_Net_ContactViewController alloc]init];
