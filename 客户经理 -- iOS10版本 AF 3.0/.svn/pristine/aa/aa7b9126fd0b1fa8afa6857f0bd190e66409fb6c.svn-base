//
//  Business_Group_DirectoruyDetailViewController.m
//  MobileAssistant
//
...
@interface Business_Group_DirectoruyDetailViewController ()<MBProgressHUDDelegate,UITextFieldDelegate>
{
    MBProgressHUD *HUD;
...
@implementation Business_Group_DirectoruyDetailViewController
