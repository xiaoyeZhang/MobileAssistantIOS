...
- (UILabel *)descriptionLabelForItemAtIndex:(NSUInteger)index{
    ...
    if (self.showAbsoluteValues) {
        ...
        titleValue = [NSString stringWithFormat:@"%.0f%%\n(%.f)",[self ratioForItemAtIndex:index] * 100,currentDataItem.value];
    }
...
//    
//    NSDictionary *attributes = @{ NSFontAttributeName:_descriptionTextFont, NSParagraphStyleAttributeName:paragraphStyle};
//    descriptionLabel.attributedText = [[NSAttributedString alloc]initWithString:descriptionLabel.text attributes:attributes];
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    [_descriptionLabels enumerateObjectsUsingBlock:^(UILabel *obj, NSUInteger idx, BOOL *stop) {
...
- (UIView*) getLegendWithMaxWidth:(CGFloat)mWidth{
    ...
    CGFloat singleRowHeight = [PNLineChart sizeOfString:@"Test"
                                              withWidth:MAXFLOAT
                                                   font:self.legendFont ? self.legendFont : [UIFont systemFontOfSize:10.0f]].height;
    ...
    for (PNPieChartDataItem *pdata in self.items) {
        ...
        CGSize labelsize = [PNLineChart sizeOfString:pdata.textDescription
                                           withWidth:maxLabelWidth
                                                font:self.legendFont ? self.legendFont : [UIFont systemFontOfSize:10.0f]];
        ...
        label.font = self.legendFont ? self.legendFont : [UIFont systemFontOfSize:10.0f];
