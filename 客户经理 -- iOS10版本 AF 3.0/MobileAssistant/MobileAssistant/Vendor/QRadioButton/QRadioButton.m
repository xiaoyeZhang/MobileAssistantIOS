...
- (void)radioBtnChecked {
    if (_checked) {
        ...
        if (_type == 1) {
            ...
            if (!self.selected && _delegate && [_delegate respondsToSelector:@selector(didDeselectedRadioButton:groupId:type:answer:)]) {
                [_delegate didDeselectedRadioButton:self groupId:_groupId type:_type answer:_answer];
    ...
    if (self.selected && _delegate && [_delegate respondsToSelector:@selector(didSelectedRadioButton:groupId:type:answer:)]) {
        [_delegate didSelectedRadioButton:self groupId:_groupId type:_type answer:_answer];
