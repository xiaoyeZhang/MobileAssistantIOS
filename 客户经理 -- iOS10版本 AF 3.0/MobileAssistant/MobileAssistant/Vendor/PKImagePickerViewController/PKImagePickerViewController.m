...
- (void)viewDidLoad
{
    ...
    UIButton *camerabutton = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.view.bounds)/2-50, CGRectGetHeight(self.view.bounds)-80, 100, 100)];
    ...
    UIButton *cancel = [[UIButton alloc]initWithFrame:CGRectMake(15, CGRectGetHeight(self.view.frame)-40, 32, 32)];
    [cancel setImage:[UIImage imageNamed:@"ca_back"] forState:UIControlStateNormal];
    ...
    UIButton *selectPhotoButton = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetWidth(overlayView.frame)-50, 20, 32, 32)];
    [selectPhotoButton setImage:[UIImage imageNamed:@"ca_ensure"] forState:UIControlStateNormal];
    ...
    [cancelSelectPhotoButton setImage:[UIImage imageNamed:@"ca_back"] forState:UIControlStateNormal];
