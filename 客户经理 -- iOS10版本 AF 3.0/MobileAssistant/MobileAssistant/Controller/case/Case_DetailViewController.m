...
- (void)addMyViews
{
    ...
    NSString *url1 = [NSString stringWithFormat:@"%@?method=%@&page=%@&id=%@&field=%@",BASEURL,@"common_page",@"case",self.entity.product_id,@"content1"];
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    NSString *url2 = [NSString stringWithFormat:@"%@?method=%@&page=%@&id=%@&field=%@",BASEURL,@"common_page",@"case",self.entity.product_id,@"content2"];
    NSURLRequest *request2 = [NSURLRequest requestWithURL:[NSURL URLWithString:url2]];
    
    NSString *url3 = [NSString stringWithFormat:@"%@?method=%@&page=%@&id=%@&field=%@",BASEURL,@"common_page",@"case",self.entity.product_id,@"content3"];
