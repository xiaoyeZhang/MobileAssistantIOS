...
- (void)viewDidLoad {
    ...
    if ([_name isEqualToString:@"集中化管理"]) {
        if ([userEntity.type_id intValue]== ROLE_CUSTOMER || [userEntity.type_id intValue]== ROLE_PRODUCT) {
            ...
            [MainBusinessArr addObject:@{@"section":@"1",@"sectionName":@"政策集中解读",@"list":
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]){
        ...
        headerView.titilabel.text = [[MainBusinessArr objectAtIndex:indexPath.section] objectForKey:@"sectionName"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_name isEqualToString:@"订单中心"]) {
        ...
        if ([ControllerStr isEqualToString:@"Business_InternationalViewController"]) {
            ...
            if ([_name isEqualToString:@"统一下单业务"]) {
