...
@interface Business_change_SumbitViewController ()<UITextFieldDelegate,MBProgressHUDDelegate,M_Product_listViewControllerDelegate,M_OrderUserViewControllerDelegate,AddPhotoViewControllerDelegate>
{
