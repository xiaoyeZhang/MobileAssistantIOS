//
//  Business_change_SumbitViewController.m
//  MobileAssistant
//
...
@interface Business_change_SumbitViewController ()<UITextFieldDelegate,MBProgressHUDDelegate,M_Product_listViewControllerDelegate,M_OrderUserViewControllerDelegate,AddPhotoViewControllerDelegate,M_Order_FormViewControllerDelegate>
{
...
@implementation Business_change_SumbitViewController
                    ...
                    if ([self.uploadImagesArr[i] isKindOfClass:[UIImage class]]) {
                        ...
                        if (i == [self.uploadImagesArr count] - 1) {
                            ...
                            [alert showAlertViewWithCompleteBlock:^(NSInteger buttonIndex) {
                                ...
                                Business_change_listViewController *vc = [[Business_change_listViewController alloc]init];
