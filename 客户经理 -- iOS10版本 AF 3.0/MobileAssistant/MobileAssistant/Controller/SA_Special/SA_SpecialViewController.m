...
@interface SA_SpecialViewController ()<UITableViewDelegate,UITableViewDataSource,MBProgressHUDDelegate,XYStartEndDatePickerDelegate>
{
...
@implementation SA_SpecialViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SA_Special_DetailViewController *vc = [[SA_Special_DetailViewController alloc]init];
