...
@interface OrderUserViewController ()<MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
}
@end
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(self.delegate && [self.delegate respondsToSelector:@selector(successOrderUserDelegate:)]){
        
        
        [_delegate successOrderUserDelegate:[self.arrayCutomer objectAtIndex:indexPath.row]];
...
- (void)getData{
    ...
    NSDictionary *dic = @{@"method":@"get_order_user",
                          @"type":_type};
