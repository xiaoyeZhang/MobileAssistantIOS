...
//    self.entity?@"update_order":@"create_order"
    ...
    if ([self.contenDic count] > 0) {
        ...
        [dict setObject:[self.contenDic objectForKey:@"do_user_id"] forKey:@"do_user_id"];
        [dict setObject:[self.contenDic objectForKey:@"do_user_name"] forKey:@"do_user_name"];
        [dict setObject:[self.contenDic objectForKey:@"sa_id"] forKey:@"sa_id"];
    }
