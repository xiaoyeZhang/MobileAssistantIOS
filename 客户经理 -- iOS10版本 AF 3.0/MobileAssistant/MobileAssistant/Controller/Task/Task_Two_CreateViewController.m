...
@interface Task_Two_CreateViewController ()<MBProgressHUDDelegate>
{
...
@implementation Task_Two_CreateViewController
...
//        _setCustomer_epresentativeBtn.userInteractionEnabled = YES;
        ...
        [_setCustomer_epresentativeBtn setTitle:compEntity.user_name forState:UIControlStateNormal];
        
        actor_id = compEntity.user_id;
        ...
        _setCustomer_epresentativeBtn.userInteractionEnabled = NO;
         ...
         [_setCustomer_epresentativeBtn setTitle:@"" forState:UIControlStateNormal];
...
- (void) doCreateTask
{
    ...
    if (FininCreateBtn == NO) {
        ...
        NSDictionary *param = [NSDictionary dictionaryWithObjectsAndKeys:
                               ...
                               @"createtask",              @"method",
                               @"1",                       @"check",
                               [yes_noStr isEqualToString:@"1"]?userEntity.is_first:@"0",        @"is_first",
