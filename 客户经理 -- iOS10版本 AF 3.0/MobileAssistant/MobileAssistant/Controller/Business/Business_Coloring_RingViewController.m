//
//  Business_Coloring_RingViewController.m
//  MobileAssistant
//
...
@interface Business_Coloring_RingViewController ()<MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
...
@implementation Business_Coloring_RingViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Business_Coloring_RingListViewController *vc = [[Business_Coloring_RingListViewController alloc]init];
