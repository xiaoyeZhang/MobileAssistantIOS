//
//  Business_MarkingPlanViewController.m
//  MobileAssistant
//
...
@interface Business_MarkingPlanViewController ()<UIScrollViewDelegate,MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
    NSDictionary *dict;
    NSString *SMS_code;
...
@implementation Business_MarkingPlanViewController
...
- (void)submitBtnClicked:(UIButton *)sender
{
    ...
    Business_MarkingPlanDetailViewController *vc = [[Business_MarkingPlanDetailViewController alloc]init];
