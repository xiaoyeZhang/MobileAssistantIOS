//
//  Business_Group_DirectoruyViewController.m
//  MobileAssistant
//
...
@interface Business_Group_DirectoruyViewController ()<MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
...
@implementation Business_Group_DirectoruyViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Business_Group_DirectoruyListViewController *vc = [[Business_Group_DirectoruyListViewController alloc]init];
