//
//  Bussiness_productViewController.m
//  MobileAssistant
//
...
@interface Bussiness_productViewController ()<MBProgressHUDDelegate>
{
    MBProgressHUD *HUD;
...
@implementation Bussiness_productViewController
...
- (void)addRefreshView
{
    ...
    refreshHeader.scrollView = _tableViewProduct;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Bussiness_ListViewController *vc = [[Bussiness_ListViewController alloc]init];
